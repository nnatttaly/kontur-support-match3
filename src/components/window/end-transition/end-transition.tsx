    ...
    <div className="final-level-content">
        ...
        <div className="button-wrapper">
          <div className="end-actions">
            ...
            onClick={onRestart}
            />
            <div className="end-sound-control">
              <button
                type="button"
                className="end-sound-toggle"
                onClick={() => setShowVolumeSlider((prev) => !prev)}
                aria-label={showVolumeSlider ? "Скрыть громкость" : "Показать громкость"}
                aria-expanded={showVolumeSlider}
              >
                <img src={volumeIcon} alt="" className="end-sound-icon" />
              </button>

              {showVolumeSlider && (
                <div className="end-sound-panel">
                  <input
                    className="end-sound-slider"
                    type="range"
                    min={0}
                    max={100}
                    value={volume}
