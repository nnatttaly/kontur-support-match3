...
export const TUTORIALS: Record<number, TutorialStep[]> = {
  1: [
    ...
    { text: "Здесь твои бонусы — пользуйся ими, чтобы быстрее достичь целей", characterPos: 'left', highlightSelector: '.bonuses-container', position: { top: '54%', left: '23%' }, mobilePosition: { top: '60%', left: '10%' }, highlightBonus: true  },
    { text: "Попробуй)", characterPos: 'left', highlightSelector: '.bonuses-container', position: { top: '54%', left: '23%' }, mobilePosition: { top: '60%', left: '10%' }, highlightBonus: true  },
