// tutorial-data.ts (assuming this is a separate file, but included here for completeness)
...
export const TUTORIALS: Record<number, TutorialStep[]> = {
  1: [
    ...
    { text: "Здесь твои бонусы — пользуйся ими, чтобы быстрее достичь целей", characterPos: 'left', highlightSelector: '.bonuses-container', position: { top: '54%', left: '23%' } },
