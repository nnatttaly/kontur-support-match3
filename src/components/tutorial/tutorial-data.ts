...
export const TUTORIALS: Record<number, TutorialStep[]> = {
  1: [
    ...
    { text: "Это количество оставшихся ходов", characterPos: 'right', highlightSelector: undefined, position: { top: '17%', left: '40%' }, mobilePosition: { top: '35%', left: '15%' }, highlightBonus: true, highlightSelectorMobile: '.moves-container'  },
