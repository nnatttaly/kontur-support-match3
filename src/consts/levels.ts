...
export const LEVELS: Level[] = [
  {
    id: 1,
    name: "Новичок",
    description: "Сегодня твой первый день в команде поддержки. Твоя цель — накапливать знания по продуктам Контура, задавать вопросы наставнику и погружаться в жизнь компании.\nУдачи!",
    goals: [
